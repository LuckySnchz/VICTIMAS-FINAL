...
<!E3 Tipo de documentación>
  ...
  <div class="">
  <input name="imputado_tipo_documento_otro"  id="imputado_tipo_documento_otro" class="form-control" type="text" value="{{$tipo_documento_otro}}">
...
<!E4 Nro documento>
  ...
  <input type="text" class="form-control" name="imputado_documento" placeholder="" id="imputado_documento" value="{{$documento_nro}}">
