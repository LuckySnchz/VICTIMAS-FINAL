...
<!-A14II Tipo de vínculo>
      ...
      <div class="">
      <input class="form-control" name="otro_vinculo_persona_asistida_cual" id="vinculo_victima_cual_otro" type="text" value="{{$otro_vinculo_persona_asistida_cual}}"><br>
