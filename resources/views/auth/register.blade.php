            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="cavaj" class="col-md-4 col-form-label text-md-right">{{ __('Cavaj') }}</label>

                            <div class="col-md-6">
                                <input id="cavaj" type="text" class="form-control{{ $errors->has('cavaj') ? ' is-invalid' : '' }}" name="cavaj" value="{{ old('cavaj') }}" required autofocus>

                                @if ($errors->has('cavaj'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('cavaj') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
